...
class LaneDetectorSensor(object):
    def __init__(self, parent_actor, hud):
        self.sensor = None
        self._parent = parent_actor
        self.hud = hud
    ...
    def draw_lane_lines(self, original_image, warped_image,  histogram, Minv):
        ...
        #plt.figure(figsize=(10, 10))
        #plt.imsave('newwrap.jpg', newwarp)
        return result
    ...
    def process_image(self, image):
        ...
        binary_warped, Minv = self.warp(binary)
...
class CameraManager(object):
    def __init__(self, parent_actor, hud, gamma_correction):
        ...
        self._camera_transforms = [
            ...
            (carla.Transform(carla.Location(x=0, y=0, z=1.5)), Attachment.Rigid),
            (carla.Transform(carla.Location(x=-5.5, z=2.5), carla.Rotation(pitch=8.0)), Attachment.SpringArm)
            ]
        self.transform_index = 1
        # only one camera needed for the project
        self.sensors = [
